...
from utils.veritabani import veritabani_baglanti_yap, tablolar_olustur
from utils.soru_yonetimi import yukle_sorular, soru_ekle, soru_sil, soru_var_mi, guncelle_soru
